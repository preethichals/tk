...
function Industry() {
  ...
  return (
   <>
      <div className=" py-10 sm:py-12 text-center bg-indigo-50 border-b-2 border-gray-300">
                ...
                <div className="mx-auto  lg:max-w-none">
                  ...
                  <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:gap-x-8 ">
                    {industry.map((callout) => (
                      <div key={callout.name} className="group shadow-xl relative transition ease-in-out  delay-150 hover:-translate-y-4 duration-300 hover:border-gray-400 hover:scale-100  group-hover:text-white border-2 bg-gradient-to-r from-sky-600 to-blue-800  hover:bg-indigo-50 ">
